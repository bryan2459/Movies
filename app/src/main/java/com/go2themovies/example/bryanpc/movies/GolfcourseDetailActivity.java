...
/**
 * An activity representing a single Golfcourse detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link GolfcourseListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link GolfcourseDetailFragment}.
 */
public class GolfcourseDetailActivity extends ActionBarActivity {
